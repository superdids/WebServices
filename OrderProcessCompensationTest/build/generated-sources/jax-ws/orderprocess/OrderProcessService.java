 ...
 * 
 */
@WebServiceClient(name = "orderProcessService", targetNamespace = "urn:orderProcess", wsdlLocation = "http://localhost:9080/OrderProcessService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9080/OrderProcessService?wsdl");
